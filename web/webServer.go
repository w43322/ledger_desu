...
func WebStart(app controller.Application) {
	...
	http.HandleFunc("/queryPage", app.QueryPage)       // 转至根据记录流水号与记录人查询信息页面
	http.HandleFunc("/query", app.FindCertByNoAndName) // 根据记录流水号与记录人查询信息

	http.HandleFunc("/queryPage2", app.QueryPage2) // 转至根据记录ID号码查询信息页面
	http.HandleFunc("/query2", app.FindByID)       // 根据记录ID号码查询信息
